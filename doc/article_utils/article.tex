...
\textbf{Nota:} Solo se probó el algoritmo de backtracking con grafos de hasta 10 nodos, ya que con dicho tamaño, para cada grafo el algoritmo tardaba en promedio 1 minuto en ejecutarse.
